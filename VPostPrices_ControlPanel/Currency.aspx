<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="Currency.aspx.cs" Inherits="VPostPrices_ControlPanel.Currency" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataKeyNames="Id" DataSourceID="SqlDataSource1">
        <Columns>
            ...
            <asp:BoundField DataField="CurrencyNameAr" HeaderText="CurrencyNameAr" SortExpression="CurrencyNameAr" />
            <asp:BoundField DataField="CurrencyNameEn" HeaderText="CurrencyNameEn" SortExpression="CurrencyNameEn" />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:PricingConnectionString %>" SelectCommand="ShowCurrency" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
        </div>
</asp:Content>
